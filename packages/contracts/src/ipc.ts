...
import type { HostCommand, MediaReadCommandInput, MediaSaveCommandInput, MediaSaveData } from './ipc-commands.js';
import type {
  HostPush,
  HostPushBatchFrame,
  HostPushSequencing,
...
export type HostStatusData = {
  ...
  capabilities: {
    ...
    /** WP5 sets this to 1 when live context telemetry is claimed. */
