...
export const DEFAULT_ARTIFACT_DECISION_PROMPT = [
  ...
  '- Information-dense reference (cheatsheet, command summary, catalog, comparison) uses an Inline Artifact: an `artifact-html` fence without `surface="canvas"`.',
...
export function formatArtifactProtocol(): string {
  return [
    ...
    '',
    `\`\`\`${CANONICAL_ARTIFACT_LANGUAGE} title="Short descriptive title" surface="canvas"`,
