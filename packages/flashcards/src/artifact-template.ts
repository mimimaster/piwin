 ...
 *
 * Pure string builder — no DOM. Self-contained scoped styles included in a <style> block.
 */
 ...
 */
export function buildFlashcardArtifactHtml(card: FlashcardReviewCard): string {
 ...
 */
export function buildFlashcardBatchArtifactHtml(cards: FlashcardReviewCard[]): string {
