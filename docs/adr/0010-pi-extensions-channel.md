...
- Third-party extensions remain full-privilege once enabled.
  [`docs/guides/pi-extensions.md`](../guides/pi-extensions.md),
  `piwin extension list`, and `piwin doctor` state the
