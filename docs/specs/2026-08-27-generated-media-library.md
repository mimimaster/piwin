...
Images and videos are never separate top-level destinations.
...
- One page. Title on the left, pill search in the middle, New on the right.
  Default tab is Images. Text tabs: Images / Videos. Sort + grid/list sit
  on the tab row. Library has no composer.
