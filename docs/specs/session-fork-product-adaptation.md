...
| SF-D4 | The newest completed assistant response shows **Duplicate + Fork**. Older completed assistant responses show **Fork only**. | Duplicate always copies the whole current session; showing it under an old response would falsely imply prefix-copy semantics. |
