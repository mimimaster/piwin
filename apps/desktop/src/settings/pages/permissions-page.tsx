  ...
  return (
    <div className="settings-card" data-testid="settings-permissions">
      <div className="settings-section">
        <PageTitle
          title={isChinese ? '权限模式' : 'Permission mode'}
          description={
            isChinese
      ...
      <div className="settings-section">
        <h4>{isChinese ? '模式说明' : 'Mode notes'}</h4>
      ...
      {hasProject ? (
        <div className="settings-section" data-testid="settings-permission-trust">
          <h4>{isChinese ? '项目信任' : 'Project trust'}</h4>
          {projectTrusted ? (
        ...
        <div className="settings-section" data-testid="settings-permission-trust">
          <h4>{isChinese ? '通用范围' : 'General scope'}</h4>
