...
export function SubagentSheet(): ReactElement {
  ...
  return <DemoSubagentSheet />;
}

function DemoSubagentSheet(): ReactElement {
  const { dispatch } = useInkstone();
  return (
    <>
      <Pill variant="azure">
...
export function SubagentOutputSheet(): ReactElement {
  ...
  return <DemoSubagentOutputSheet />;
}

function DemoSubagentOutputSheet(): ReactElement {
  const { dispatch } = useInkstone();
  return (
    <>
...
export function InterveneSheet(): ReactElement {
  ...
  return <DemoInterveneSheet />;
}

function DemoInterveneSheet(): ReactElement {
  const { dispatch } = useInkstone();
