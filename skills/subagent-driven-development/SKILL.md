...
description: "Execute an approved plan by delegating isolatable steps to isolated child sessions (Host serializes writers), then review diffs and verify in the parent. Use when the user chooses subagent execution for a plan (子代理执行); also /subagent-driven-development."
version: 3
---
